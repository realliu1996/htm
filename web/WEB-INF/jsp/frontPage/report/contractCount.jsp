    ...
    <div class="container">
        ...
        <div class="bs-docs-example">
            <table class="table table-hover" style="text-align: center">
                <thead>
                <tr>
                    <th style="width: 8%"><center>序号</center></th>
                    <th style="width: 10%"><center>房屋小区</center></th>
                    <th style="width: 10%"><center>房东名称</center></th>
                    <th style="width: 15%"><center>中介名称</center></th>
                    <th style="width: 8%"><center>租房单价</center></th>
                    <th style="width: 9%"><center>租房时间</center></th>
