            ...
            <div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
                <nav class="link-effect-12">
                    <ul class="nav navbar-nav w3_agile_nav">
                        ...
                        <li class="active"><a href="tenantApplication/selectByCondForTenant"><span>我的申请</span></a></li>
        ...
        <div class="bs-docs-example">
            <table class="table table-hover" style="text-align: center">
                ...
                <tr>
                    ...
                    <th style="width: 13%"><center>申请时间</center></th>
                    <th style="width: 12%"><center>租房时间</center></th>
                    <th style="width: 10%"><center>状态</center></th>
                </tr>
                </thead>
                <tbody>
                <c:forEach items="${tenantApplications}" var="tenantApplications" varStatus="status">
                    <tr onclick="house(${tenantApplications.houseId});">
