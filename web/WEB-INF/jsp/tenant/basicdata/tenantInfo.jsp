            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="../../index.html"><i class="fa fa-circle-o"></i> 房源信息</a></li>
                    </ul>
                </li>
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li id="sales"><a href="../tables/simple.html"><i class="fa fa-circle-o"></i> 我的求租</a></li>
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="../charts/chartjs.html"><i class="fa fa-circle-o"></i> 我的收藏</a></li>
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li class="active"><a href="/showtenantinfo"><i class="fa fa-circle-o"></i> 租客信息</a></li>
                        <li><a href="/showtenantsystem"><i class="fa fa-circle-o"></i> 系统信息</a></li>
                    </ul>
                </li>
                    ...
                    <div class="box-body">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr height="75px">
                                ...
                                <td width="35%" style="vertical-align:middle; text-align:left;">${sessionScope.tenant.tenantNick }</td>
                                <td width="15%" style="vertical-align:middle; text-align:center;">角色</td>
                                <td width="35%" style="vertical-align:middle; text-align:left;">${sessionScope.tenant.role }</td>
                            </tr>
                            <tr height="75px">
                                <td style="vertical-align:middle; text-align:center;">真实姓名</td>
                                <td style="vertical-align:middle; text-align:left;">${sessionScope.tenant.tenantName }</td>
                                <td style="vertical-align:middle; text-align:center;">性别</td>
                                <td style="vertical-align:middle; text-align:left;">${sessionScope.tenant.tenantSex }</td>
                            </tr>
                            <tr height="75px">
                                <td style="vertical-align:middle; text-align:center;">出生年月</td>
                                <td style="vertical-align:middle; text-align:left;">${sessionScope.tenant.tenantBirth }</td>
                                <td style="vertical-align:middle; text-align:center;">联系地址</td>
                                <td style="vertical-align:middle; text-align:left;">${sessionScope.tenant.tenantAddr }</td>
                            </tr>
                            <tr height="75px">
                                <td style="vertical-align:middle; text-align:center;">联系电话</td>
                                <td style="vertical-align:middle; text-align:left;">${sessionScope.tenant.tenantTel }</td>
                                <td style="vertical-align:middle; text-align:center;">联系邮箱</td>
                                <td style="vertical-align:middle; text-align:left;">${sessionScope.tenant.tenantMail }</td>
                            </tr>
                            <tr height="75px">
                                <td style="vertical-align:middle; text-align:center;">工作</td>
                                <td style="vertical-align:middle; text-align:left;">${sessionScope.tenant.tenantWork }</td>
                                <td style="vertical-align:middle; text-align:center;">收入水平</td>
                                <td style="vertical-align:middle; text-align:left;">${sessionScope.tenant.tenantIncome }</td>
                            </tr>
