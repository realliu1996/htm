    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="box box-default">
                ...
                <!-- /.box-header -->
                <form class="form-horizontal" role="form" action="tenant/updateTenant" method="post">
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="hidden" name="userId" value="${sessionScope.tenant.userId }" />
                                        <input type="text" class="form-control" placeholder="" name="tenantNick" value="${sessionScope.tenant.tenantNick }" readonly>
                                    </div>
                                </div>
                                <!-- /.form-group -->
                                <div class="form-group"></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control pull-right" id="datepicker" name="tenantBirth">
                                    </div>
                                </div>
                                <!-- /.form-group -->
                                <div class="form-group"></div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" placeholder="" name="tenantTel">
                                    </div>
                                </div>
                                <!-- /.form-group -->
                                <div class="form-group"></div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" placeholder="" name="tenantWork">
                                    </div>
                                </div>
                                <!-- /.form-group -->
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" placeholder="" name="role" value="${sessionScope.tenant.role }" readonly>
                                    </div>
                                </div>
                                <!-- /.form-group -->
                                <div class="form-group"></div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control select2" style="width: 100%;" name="tenantSex">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" placeholder="" name="tenantAddr">
                                    </div>
                                </div>
                                <!-- /.form-group -->
                                <div class="form-group"></div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" placeholder="" name="tenantMail">
                                    </div>
                                </div>
                                <!-- /.form-group -->
                                <div class="form-group"></div>
                                <div class="form-group">
                                    <label class="col-sm-4 control-label">收入水平</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" placeholder="" name="tenantIncome">
