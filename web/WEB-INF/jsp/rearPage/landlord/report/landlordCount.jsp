...
<div class="wrapper">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li class="active"><a href="landlordApplication/selectByCondCount"><i class="fa fa-circle-o"></i> 我的录入</a></li>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                <form class="form-horizontal" role="form" action="landlordApplication/selectByCondCount" method="post">
                    <div class="col-md-12">
                        <div class="box">
                        ...
                        <div class="box-body">
                            <table class="table table-bordered">
                                <tr>
                                    ...
                                    <th style="width: 30%">申请单类型</th>
                                    <th style="width: 25%">中介</th>
