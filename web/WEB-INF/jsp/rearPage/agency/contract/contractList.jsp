...
<div class="wrapper">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li class="active" id="create"><a href="contract/selectForAgency"><i class="fa fa-circle-o"></i> 房屋合同</a></li>
                    </ul>
                </li>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                <form class="form-horizontal" role="form" action="contract/selectForAgency" method="post">
                    <div class="col-md-12">
                        <div class="box">
