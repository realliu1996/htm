            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="active"><a href="tenantApplication/selectByCond"><i class="fa fa-circle-o"></i>  租房审核</a></li>
                    </ul>
                </li>
                        ...
                        <div class="box-body">
                            <table class="table table-bordered" style="text-align: center">
                                <tr>
                                    ...
                                    <th style="width: 10%"><center>申请单类型</center></th>
                                ...
                                <c:forEach items="${tenantApplications}" var="tenantApplications" varStatus="status">
                                    <tr>
                                        ...
                                        <td>
                                            <a onclick="tenant(${tenantApplications.applyId},${tenantApplications.houseId},${tenantApplications.tenantId});" aria-label="处理">
...
<script type="text/javascript">
    ...
    $("#application").click(function () {
        ...
        $.ajax({
            url:"${pageContext.request.contextPath}/tenantApplication/reviewForTenant",
            type: "POST",
            ...
            success:function(data){
                if (data == "true") {
                    ...
                    setTimeout(function(){
                        $("#myModal").modal('hide');
                        window.location.href = "tenantApplication/selectByCond";
                    },1000)
                }else {
                    toastr.options.positionClass = 'toast-center-center';
                    toastr.info("审核失败");
