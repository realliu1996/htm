...
<div class="wrapper">
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="active"><a href="tenantApplication/selectCountForAgency"><i class="fa fa-circle-o"></i> 租赁处理</a></li>
                    </ul>
                </li>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
                <form class="form-horizontal" role="form" action="tenantApplication/selectCountForAgency" method="post">
                    <div class="col-md-12">
                        <div class="box">
