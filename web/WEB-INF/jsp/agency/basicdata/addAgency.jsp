    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="box box-default">
                ...
                <!-- /.box-header -->
                <form class="form-horizontal" role="form" action="agency/updateAgency" method="post">
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="hidden" name="userId" value="${sessionScope.agency.userId }" />
                                        <input type="text" class="form-control" placeholder="" name="agencyNick" value="${sessionScope.agency.agencyNick }" readonly>
                                    </div>
                                </div>
                                <!-- /.form-group -->
                                <div class="form-group"></div>
                                <div class="form-group">
                                    <label class="col-sm-4 control-label">中介名称</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" placeholder="" name="agencyName">
                                    </div>
                                </div>
                                <!-- /.form-group -->
                                <div class="form-group"></div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" placeholder="" name="agencyAddr">
                                    </div>
                                </div>
                                <!-- /.form-group -->
                                <div class="form-group"></div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" placeholder="" name="agencyMail">
                                    </div>
                                </div>
                                <!-- /.form-group -->
                                <div class="form-group"></div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" placeholder="" name="agencyFunds">
                                    </div>
                                </div>
                                <!-- /.form-group -->
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" placeholder="" name="role" value="${sessionScope.agency.role }" readonly>
                                    </div>
                                </div>
                                <!-- /.form-group -->
                                <div class="form-group"></div>
                                <div class="form-group">
                                    <label class="col-sm-4 control-label">中介法人</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" placeholder="" name="agencyLegal">
                                    </div>
                                </div>
                                <!-- /.form-group -->
                                <div class="form-group"></div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" placeholder="" name="agencyTel">
                                    </div>
                                </div>
                                <!-- /.form-group -->
                                <div class="form-group"></div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control pull-right" id="datepicker" name="established">
