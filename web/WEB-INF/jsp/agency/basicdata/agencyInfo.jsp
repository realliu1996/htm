        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li class="active"><a href="/showagencyinfo"><i class="fa fa-circle-o"></i> 中介信息</a></li>
                    ...
                    <div class="box-body">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr height="75px">
                                ...
                                <td width="35%" style="vertical-align:middle; text-align:left;">${sessionScope.agency.agencyNick }</td>
                                <td width="15%" style="vertical-align:middle; text-align:center;">角色</td>
                                <td width="35%" style="vertical-align:middle; text-align:left;">${sessionScope.agency.role }</td>
                            </tr>
                            <tr height="75px">
                                <td style="vertical-align:middle; text-align:center;">中介名称</td>
                                <td style="vertical-align:middle; text-align:left;">${sessionScope.agency.agencyName }</td>
                                <td style="vertical-align:middle; text-align:center;">中介法人</td>
                                <td style="vertical-align:middle; text-align:left;">${sessionScope.agency.agencyLegal }</td>
                            </tr>
                            <tr height="75px">
                                <td style="vertical-align:middle; text-align:center;">联系地址</td>
                                <td style="vertical-align:middle; text-align:left;">${sessionScope.agency.agencyAddr }</td>
                                <td style="vertical-align:middle; text-align:center;">联系电话</td>
                                <td style="vertical-align:middle; text-align:left;">${sessionScope.agency.agencyTel }</td>
                            </tr>
                            <tr height="75px">
                                <td style="vertical-align:middle; text-align:center;">联系邮箱</td>
                                <td style="vertical-align:middle; text-align:left;">${sessionScope.agency.agencyMail }</td>
                                <td style="vertical-align:middle; text-align:center;">成立时间</td>
                                <td style="vertical-align:middle; text-align:left;">${sessionScope.agency.established }</td>
                            </tr>
                            <tr height="75px">
                                <td style="vertical-align:middle; text-align:center;">注册资金</td>
                                <td style="vertical-align:middle; text-align:left;">${sessionScope.agency.agencyFunds }</td>
                            </tr>
